        ...
        <form action="../_bd/edit_water.php" method="POST">
            ...
            <fieldset><legend>Economias:</legend>
                <select name="categoria_imovel" id="categoria_imovel">
                    <option value="Residencial 001" <?php if(isset($res) && !empty($res) && $res['categoria_imovel'] == 'Residencial 001') {echo 'selected';} ?> required>Residencial 001</option>
                    <option value="Residencial 002" <?php if(isset($res) && !empty($res) && $res['categoria_imovel'] == 'Residencial 002') {echo 'selected';} ?> required>Residencial 002</option>
                    <option value="Residencial 003" <?php if(isset($res) && !empty($res) && $res['categoria_imovel'] == 'Residencial 003') {echo 'selected';} ?> required>Residencial 003</option>
                    <option value="Comercial 001" <?php if(isset($res) && !empty($res) && $res['categoria_imovel'] == 'Comercial 001') {echo 'selected';} ?> required>Comercial 001</option>
                    <option value="Comercial 002" <?php if(isset($res) && !empty($res) && $res['categoria_imovel'] == 'Comercial 002') {echo 'selected';} ?> required>Comercial 002</option>
                    <option value="Industrial 001" <?php if(isset($res) && !empty($res) && $res['categoria_imovel'] == 'Industrial 001') {echo 'selected';} ?> required>Industrial 001</option>
                    <option value="Pública 001" <?php if(isset($res) && !empty($res) && $res['categoria_imovel'] == 'Pública 001') {echo 'selected';} ?> required>Pública 001</option>
                </select>
            </fieldset><br>
            ...
            <input type="number" name="volume_m3" id="volume_m3" min="1" max="255" placeholder="000" value="<?php if(isset($res)) {echo $res['volume_m3'];} ?>" required><br>
            ...
            <input type="number" name="valor_consumo" id="valor_consumo" min="1" max="999.99" step="0.01" placeholder="R$ 00.00" value="<?php if(isset($res)) {echo $res['valor_consumo'];} ?>" required><br>
            ...
            <input type="number" name="tarifa_juros" id="tarifa_juros" min="0" max="0.999" step="0.001" placeholder="0.000" value="<?php if(isset($res)) {echo $res['tarifa_juros'];} ?>"><br>
            ...
            <input type="number" name="total" id="total" min="1" max="999.99" step="0.01" placeholder="R$ 000.00" value="<?php if(isset($res)) {echo $res['total'];} ?>" required><br><br>
