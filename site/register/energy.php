...
<body>
    ...
    <div class="register">
        ...
        <form action="../_bd/edit_energy.php" method="POST">
            ...
            <input type="number" name="ilum_public" id="ilum_public" min="0.01" max="99.99" step="0.01" placeholder="R$ 00.00" value="<?php if (isset($res)) {echo $res['ilum_public'];} ?>"><br>
            <label for="tarifa_kWh">Tarifa kWh*: </label>
            <input type="number" name="tarifa_kWh" id="tarifa_kWh" min="0.00001" max="0.99999" step="0.00001" placeholder="0.00000" value="<?php if (isset($res)) {echo $res['tarifa_kWh'];} ?>"><br>
            <label for="valor_consumo">Valor consumo*: </label>
            <input type="number" name="valor_consumo" id="valor_consumo" min="0.01" max="999.99" step="0.01" placeholder="R$ 000.00" value="<?php if (isset($res)) {echo $res['valor_consumo'];} ?>"><br>
            ...
            <input type="number" name="total" id="total" min="1" max="999.99" step="0.01" placeholder="R$ 00.00" value="<?php if (isset($res)) {echo $res['total'];} ?>"><br>
            ...
            <input type="number" name="consumo_kWh" id="consumo_kWh" min="1" max="255"  placeholder="000" value="<?php if (isset($res)) {echo $res['consumo_kWh'];} ?>"><br>
